...
/// Byte 0 Shape                   Type 13 int 1 Little
...
/// * optional
/// </summary>
public sealed record PolyLineZ : Geometry
{
    public override ShapeType ShapeType { get { return ShapeType.PolyLineZ; } }
    ...
    public PolyLineZ(BoundingBox box,
                     int         numParts,
                     int         numPoints,
                     Limits      zRange,
                     Limits      mRange)
    ...
    public PolyLineZ(BinaryReader reader)
    {
...
//are stored end to end. The measures for Part 2 follow the measures for Part 1, and so on. The parts array holds the array index of the starting measure
//for each part. There is no delimiter in the measure array between parts.
